...
- Utwórz projekt React z create-vite: `npm init --yes vite@latest solutionordersreact.client -- --template=react`.
- Utwórz plik projektu (`solutionordersreact.client.esproj`).
